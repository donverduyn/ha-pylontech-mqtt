...
async def async_setup_entry(
    ...
    entities.append(
        PylontechSystemSensor(
            coordinator, unique_id_prefix, "sys_cycles", None, None, "cycles", state_class=SensorStateClass.MEASUREMENT
        )
    )
    # Raw Data (System)
    entities.append(
    ...
    entities.append(
        PylontechSystemSensor(
            coordinator, unique_id_prefix, "sys_spec", None, None, "spec", entity_category=EntityCategory.DIAGNOSTIC
        )
    )
    entities.append(
        PylontechSystemSensor(
